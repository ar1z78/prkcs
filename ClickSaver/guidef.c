...
// **** Mission tab ****
    PU_ACTION_OBJDEF, CS_MISSIONS_TAB, ( PUU32 )"VerGroup", 0,
        ...
        PUM_ADDCHILD, PU_TITLE( "Buying agent" ),
		...
		PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_STATUS_TEXT, (PUU32)"Text",
		PUA_TEXT_STRING, (PUU32)"Project RK Click Saver",
...
// **** Item list tab ****
	...
	PUM_ADDCHILD, PU_FRAMED_VERGROUP(PUFRAME_GROUP, "Item list"),
...
// **** Location list tab ****
	PUM_ADDCHILD, PU_FRAMED_VERGROUP(PUFRAME_GROUP, "Location list"),
        ...
        PUM_ADDCHILD, PU_TITLE( "Choose Mission types that you want" ),
		PUM_ADDCHILD, PU_HORGROUP,
        ...
        PU_ENDGROUP,
        PUM_ADDCHILD, PU_TITLE( "Mission Seach Options" ),
        PUM_ADDCHILD, PU_HORGROUP,
...
// **** Options tab ****
    PU_ACTION_OBJDEF, CS_OPTIONS_TAB, ( PUU32 )"VerGroup", 0,
                    ...
                    PU_HORGROUP,
                        PUM_ADDCHILD, PU_LEFT_VERGROUP,
                            ...
                            PUM_ADDCHILD, PU_CHECKBOX( CS_EXPAND_CB, "Auto Expand Team Missions" ),
								PUM_ADDCHILD, PU_HORGROUP,
								PUM_ADDCHILD, PU_LABEL("Wait time between clicks in ms:"),
								PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_ROLLWAIT, (PUU32)"TextEntry",
									PUA_CONTROL_WEIGHT, 1,
									PUA_TEXTENTRY_NUMERIC, TRUE,
									PUA_TEXTENTRY_BUFFERSIZE, 9,
									PUA_TEXTENTRY_MAX, 999999999,
									PUA_TEXTENTRY_VALUE, 5000,
									PUA_TEXTENTRY_MIN, 0,
		...
		PUM_ADDCHILD, PU_LEFT_VERGROUP,
		PUM_ADDCHILD, PU_HORGROUP,
		PUM_ADDCHILD, PU_FRAMED_VERGROUP(PUFRAME_GROUP, "Mission Sliders"),
		PUM_ADDCHILD, PU_HORGROUP,
		...
		0, 0,
		PU_ENDGROUP, PUM_ADDCHILD, PU_HORGROUP,
		...
		PUM_ADDCHILD, PU_FRAMED_VERGROUP(PUFRAME_GROUP, "IMPORTANT:"),
		PUM_ADDCHILD, PU_LABEL("Choose Mission slider amounts"),
		PUM_ADDCHILD, PU_LABEL("0 = full left, 100 = full right"),
		PUM_ADDCHILD, PU_LABEL(" "),
		PUM_ADDCHILD, PU_LABEL("Sliders must be in default positions"),
		PUM_ADDCHILD, PU_LABEL("and the 'More Options' section of the"),
        ...
        PUM_ADDCHILD, PU_HORGROUP,
              PUM_ADDCHILD, PU_CHECKBOX( CS_ITEMVALUE_MSINGLE, "Match Single Item Value:"),
              PUM_ADDCHILD, PU_HORGROUP,
...
// **** Main window ***
    ...
    PUA_WINDOW_CONTENTS,
        PU_ACTION_OBJDEF, CS_TABS, ( PUU32 )"Register",
            ...
            PUM_REGISTER_ADDTAB, ( PUU32 )"Search",
            PUM_REGISTER_ADDTAB, ( PUU32 )"Settings",
